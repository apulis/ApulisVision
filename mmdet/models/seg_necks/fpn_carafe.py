...
class FPN_CARAFE(nn.Module):
    ...
    def __init__(self,
        ...
        self.fpn_conv_level = fpn_conv_level
        ...
        fpn_conv_layers = []
        for j in range(fpn_conv_level):
            input_channels = inter_channels if j == 0 else out_channels
        ...
        for i in range(self.start_level, self.backbone_end_level):
            l_conv = ConvModule(
                ...
                inplace=False,
                order=self.order)
            fpn_conv = nn.Sequential(*fpn_conv_layers)
            ...
            if i != self.backbone_end_level - 1:
                ...
                if self.upsample == 'deconv':
                    ...
                    upsample_cfg_.update(channels=inter_channels, scale_factor=2)
                else:
                    # suppress warnings
                    align_corners = (None
