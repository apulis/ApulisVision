...
data = dict(
    ...
    train=[
        ...
        dict(
        type='RPC_Dataset',
        ann_file='/data/wedward/jobs/20200503_faster_rcnn_r101_fpn_mmdet_rpc_pseudo_label/test_result/pseudo_label.json',
    ...
    #train=dict(
    #    type='RPC_Dataset',
    #    ann_file='/data/wedward/jobs/20200503_faster_rcnn_r101_fpn_mmdet_rpc_pseudo_label/val_result/pseudo_label.json',
    ...
    val=dict(
        ...
        img_prefix=data_root + 'val2019/',
        export_result_dir = "/data/wedward/jobs/20200503_faster_rcnn_r101_fpn_mmdet_rpc_pseudo_label/val_result/",
    ...
    test=dict(
        ...
        img_prefix=data_root + 'test2019/',
        export_result_dir = "/data/wedward/jobs/20200503_faster_rcnn_r101_fpn_mmdet_rpc_pseudo_label/test_result/",
        generate_pseudo_label=True,
        pipeline=test_pipeline))

evaluation = dict(interval=1, metric='bbox')
evaluation_test = dict(interval=4, metric='bbox')
# optimizer
