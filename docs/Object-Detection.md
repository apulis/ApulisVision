...
A comparison between v1.x and v2.0 codebases can be found in [compatibility.md](./compatibility.md).
...
Please see [getting_started.md](./getting_started.md) for the basic usage of MMDetection. There are also tutorials for [finetuning models](./tutorials/finetune.md), [adding new dataset](./tutorials/new_dataset.md), [designing data pipeline](./tutorials/data_pipeline.md), and [adding new modules](./tutorials/new_modules.md).
